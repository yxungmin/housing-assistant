 ...
 *  - calendar: 날짜 "8"이 글자로 박혀 있어 어느 공고든 8일로 보였다. 뺐다. 흰 칸은 가운데로 옮겼다.
 *  - home-filled · bookmark-filled · user-filled: 원본에 없다. 탭바 선택 표시로 우리가 더했다.
 *    선 버전과 같은 d에 fill과 stroke를 같이 걸어, 실루엣이 같고 속만 차게 했다.
 *  - delete · filter · heart(-filled) · more · search · user-edit · x-circle · calendar · house-check: 어느 화면도 쓰지 않아 뺐다 (2026-09-24).
 *    필요해지면 원본에서 다시 가져온다.
 *  - minus · plus · lock · logout: 선 아이콘(currentColor)인데 ASSET에 들어 있었다. 그래서 쓰는 쪽의 색이
 *    무시돼 내 정보에서 로그아웃만 검게 튀었다. MONO로 옮겼다 (2026-09-24).
 *  - pin · document · contrast: 원본에 없다. 내 정보 목록이 선 아이콘 한 가족으로 서도록 우리가 더했다.
 *    지도 핀(map-pin)·공고문(notice)은 색이 박힌 그림이라 설정 목록에 섞으면 그것만 튄다.
 */
...
export const MONO_ICONS = {
  ...
  "home-filled": `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" color="currentColor"><path d="M4.8 10.7 12 4.9l7.2 5.8v7.9c0 .72-.58 1.3-1.3 1.3H6.1c-.72 0-1.3-.58-1.3-1.3v-7.9Z" fill="currentColor" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"/></svg>`,
  "bookmark-filled": `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" color="currentColor"><path d="M7.15 4.8h9.7c.6 0 1.08.48 1.08 1.08V19l-5.93-3.05L6.07 19V5.88c0-.6.48-1.08 1.08-1.08Z" fill="currentColor" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"/></svg>`,
  "user-filled": `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" color="currentColor"><circle cx="12" cy="8.0" r="3.15" fill="currentColor" stroke="currentColor" stroke-width="2.25"/><path d="M5.55 19.15c.36-3.22 3.05-5.2 6.45-5.2s6.09 1.98 6.45 5.2" fill="currentColor" stroke="currentColor" stroke-width="2.25" stroke-linecap="round" stroke-linejoin="round"/></svg>`,
  ...
  "minus": `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" color="currentColor"><path d="M6.4 12h11.2" fill="none" stroke="currentColor" stroke-width="2.55" stroke-linecap="round"/></svg>`,
  "plus": `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" color="currentColor"><path d="M6.4 12h11.2M12 6.4v11.2" fill="none" stroke="currentColor" stroke-width="2.55" stroke-linecap="round"/></svg>`,
  "lock": `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" color="currentColor"><rect x="5.6" y="10.4" width="12.8" height="9.3" rx="2.2" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linejoin="round"/><path d="M8.6 10.4V8a3.4 3.4 0 0 1 6.8 0v2.4" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round"/><circle cx="12" cy="15" r="1.25" fill="currentColor"/></svg>`,
  "logout": `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" color="currentColor"><path d="M14.2 5.3H7.3c-.66 0-1.2.54-1.2 1.2v11c0 .66.54 1.2 1.2 1.2h6.9" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"/><path d="M17.4 8.8 20.6 12l-3.2 3.2" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"/><path d="M20.1 12h-8.4" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"/></svg>`,
  "pin": `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" color="currentColor"><path d="M12 20.4s6-5.2 6-10.2a6 6 0 1 0-12 0c0 5 6 10.2 6 10.2Z" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linejoin="round"/><circle cx="12" cy="10.1" r="2.2" fill="none" stroke="currentColor" stroke-width="2.1"/></svg>`,
  "document": `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" color="currentColor"><path d="M7.4 4.3h6.3l4.2 4.2v10c0 .7-.56 1.25-1.25 1.25H7.4c-.7 0-1.25-.56-1.25-1.25V5.55c0-.7.56-1.25 1.25-1.25Z" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linejoin="round"/><path d="M13.5 4.5v3.4c0 .42.34.76.76.76h3.4" fill="none" stroke="currentColor" stroke-width="2" stroke-linejoin="round"/><path d="M9.2 13h5.6M9.2 16.3h3.6" fill="none" stroke="currentColor" stroke-width="2.1" stroke-linecap="round"/></svg>`,
  "contrast": `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" color="currentColor"><circle cx="12" cy="12" r="8.2" fill="none" stroke="currentColor" stroke-width="2.2"/><path d="M12 3.8a8.2 8.2 0 0 1 0 16.4Z" fill="currentColor"/></svg>`,
} as const;
