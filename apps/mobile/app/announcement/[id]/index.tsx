...
import { displayTrack, expectedRank, haversineKm, RANK_VS_PAST_LABEL, rankVsPast, type RuleResult, pastResultText, toughest } from "@housing/engine";
...
export default function AnnouncementDetail() {
  ...
  const track = match ? displayTrack(match) ?? null : null;
